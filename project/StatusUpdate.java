...
public class StatusUpdate extends Event {
	...
	public void realizeEvent(Object o) {
		...
		System.out.println("Number of realized events:		"+sim.numberofevents); /*numero de eventos realizados ate ao momento*/
															
		System.out.println("Population size:			"+sim.pop.individuals.size()); /*Tamanho atual da população*/
		     																
		/*Se o melhor custo estive a zero nenhum individuo atingiu o ponto final*/
		if(sim.bestcost==0) {
			System.out.println("Final point has been hit:		NO"); /*Indica que ponto final nao foi atingido*/
			...
			System.out.println("Final point has been hit:		YES"); /*Indica que o ponto final foi atingido*/
